...
Feature: Report notes testing
  ...
  Scenario Outline: Complete indepth testing of an items notes
    ...
    Examples:
      ...
      | Test All Controls RM | Report Items - Notes (ReleaseVersion) | Reference Notes Testing | TODAY      | ONEWEEK | Notes for each report item extra notes | Preformatted Text for Copy/Paste Tests | !@$%^&*()_+=-[]}{\?><,./~` |