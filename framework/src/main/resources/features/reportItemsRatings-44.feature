Feature: Ratings testing
  ...
  Scenario Outline: Confirm ratings are working correctly
    ...
    And I confirm the rating "<option1>" is displayed in report view for "<item>"
    And I select the item "<item>"
    And I confirm for "<item>", "<option1>" is selected
    ...
    And I confirm the rating "<option2>" is displayed in report view for "<item>"
    And I select the item "<item>"
    And I confirm for "<item>", "<option2>" is selected
    And I select the "<item>" rating "<option2>"
    And I confirm all the "<item>" ratings are deselected "<option1>", "<option2>", "<option3>"
    And I select the tick or done button
    And I select the "<item>" rating "<option3>" in report view
    And I confirm the rating "<option3>" is displayed in report view for "<item>"
    And I select the item "<item>"
    And I confirm for "<item>", "<option3>" is selected
