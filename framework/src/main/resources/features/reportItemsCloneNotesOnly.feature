Feature: Cloning Reports
  ...
  Scenario Outline: Clone a report copying including all media
    ...
    Examples:
      ...
      | Cloning - Template | Reports - Clone - Notes Only | Reference Clone Notes Only | true                 | 14 February 2026 | true          | 31 October 2025 | Clone report with notes only | true     | false     |
