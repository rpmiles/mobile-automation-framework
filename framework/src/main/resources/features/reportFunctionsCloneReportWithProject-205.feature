Feature: Create a report,assign a Project and when cloning modify the Project
  ...
  Scenario Outline: Create report and assign a Client
    ...
    Examples:
      ...
      | Test All Controls RM | true            | Source Project | false          | Source Client | Mobile - Reports - Modify Project during cloning (Source) | Project Clone Reference | TODAY      | ONEWEEK | Project Clone Extra Notes |


  Scenario Outline: Clone the report selecting a different Project
    ...
    And I select the context menu
    And I select Report Settings
    Then I confirm the correct project "<ProjectName>" is displayed
    And I select cancel
    ...
    Examples:
      ...
      | Mobile - Reports - Modify Project during cloning (Source) | true            | Cloned Project | false          | Cloned Client | Mobile - Reports - Modify Project during cloning (Cloned) | Reference Clone Content Only | true                 | 14 February 2026 | true          | 31 October 2026 | Clone report with modified Project | false    | false     |
