Feature: Cloning Reports with all media
  ...
  Scenario Outline: Clone a report with all media
    ...
    Examples:
      ...
      | Clone Testing - Master | Mobile - Reports - Clone - All | Reference Clone Multi Text All | true                 | 14 February 2026 | true          | 31 October 2025 | Clone report with notes only | true     | true      |
