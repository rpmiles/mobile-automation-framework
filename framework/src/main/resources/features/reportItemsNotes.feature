...
Feature: Report notes testing
  ...
  Scenario Outline: Complete indepth testing of an items notes
    ...
    Then I select the tick or done button
    ...
    Examples:
      ...
      | Test All Controls RM | Report Items - Notes (ReleaseVersion) | Reference Notes Testing | Notes for each report item extra notes | Preformatted Text for Copy/Paste Tests | !@$%^&*()_+=-[]}{\?><,./~`  |