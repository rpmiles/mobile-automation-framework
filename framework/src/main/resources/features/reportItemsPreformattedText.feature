Feature: Preformatted Text Item Testing

  @reportItems
  Scenario Outline: Confirming preformatted text fields function correctly
    ...
    And I reselect the report
    And I select the item "<item>"
    #And I confirm the bullet list has saved for "<item>"
    ...
    Examples:
      ...
      | Test All Controls RM | Mobile - Report Items - Preformatted Text | Preformatted Text Reference | TODAY      | ONEWEEK | Preformatted Text Extra Notes | Preformatted Text for Copy/Paste Tests | Specific text entered for validation purposes |