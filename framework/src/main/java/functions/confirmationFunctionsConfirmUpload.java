...
public class confirmationFunctionsConfirmUpload extends Base_PO {
    ...
    private String uploadEnterBoldExpected = "<strong>Entering some bold text to confirm form uploads correctly</strong>";
    private String uploadEnterItalicsExpected = "<em>Entering some italics text to confirm form uploads correctly</em>";
    private String uploadEnterUnderlinedExpected = "<u>Entering some underlined text to confirm form uploads correctly</u>";
    private String uploadEnterMultiFormattedExpected = "<strong>Bold text with <em>some added italics, </em></strong><em><u>added underline but removed bold, </u><s><u>completed with strikethrough </u></s></em><strong><s>changed with simple bold and finally </s></strong>removed all formatting";
    ...
    //Confirm report view
     public void confirmUploadReportViewPreformattedText() throws IOException, URISyntaxException, InterruptedException {
        try {
            ...
            Assert.assertTrue(reportViewPreformattedText.contains(preformattedUploadTextExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }

     public void confirmUploadReportViewSingleText() throws IOException, URISyntaxException, InterruptedException {
        try {
            System.out.println("Confirming uploaded Single Text in report view");
            waitForWebElementToBeVisible(singleTextReportView);
            String reportViewSingleText = singleTextReportView.getText();
            System.out.println("Single Text displayed in Report View: \n" + reportViewSingleText);
            Assert.assertTrue(reportViewSingleText.contains(singleTextUploadExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }

     public void confirmUploadReportViewMultiText() throws IOException, URISyntaxException, InterruptedException {
        try {
            System.out.println("Confirming uploaded Multi Text in report view");
            waitForWebElementToBeVisible(multiTextReportView);
            String reportViewMultiText = multiTextReportView.getText();
            System.out.println("Multi Text displayed in Report View: \n" + reportViewMultiText);
            Assert.assertTrue(reportViewMultiText.contains(multiTextUploadExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }
     ...
     public void confirmUploadedReportViewPrefilledSingleText() throws IOException, URISyntaxException, InterruptedException {
        try {
            System.out.println("Confirming uploaded Prefilled Single Text in report view");
            waitForWebElementToBeVisible(prefilledTextSingleReportView);
            String reportViewPrefilledSingleText = prefilledTextSingleReportView.getText();
            System.out.println("Prefilled Single Text displayed in Report View: \n" + reportViewPrefilledSingleText);
            Assert.assertTrue(reportViewPrefilledSingleText.contains(prefilledSingleUploadExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }

     public void confirmUploadedReportViewPrefilledMultiText() throws IOException, URISyntaxException, InterruptedException {
        try {
            System.out.println("Confirming uploaded Prefilled Multi Text in report view");
            waitForWebElementToBeVisible(prefilledTextMultiReportView);
            String reportViewPrefilledMultiText = prefilledTextMultiReportView.getText();
            Assert.assertTrue(reportViewPrefilledMultiText.contains(prefilledMultiUploadExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }

     public void confirmUploadReportViewSwitch() throws IOException, URISyntaxException {
        try {
            System.out.println("Checking Switch report view value");
            ...
            Assert.assertTrue(actualSwitchReportViewText.contains(switchUploadExpected));
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm numeric entry");
        }
    }

     public void confirmUploadReportViewMultiPicklist() throws IOException, URISyntaxException {
        try {
            waitForWebElementToBeVisible(multiPickListReportView);
            System.out.println("Confirming selected multi picklist options in report view");
            ...
            Assert.assertTrue(actualmultiPickListReportViewText.contains(multiPicklistUploadExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
     ...
     public void confirmUploadReportViewBakedInTokens() throws IOException, URISyntaxException {
        try {
            ...
            Assert.assertTrue(actualBakedInReportViewText.contains(bakedInTokensExpected));
        } catch (NoSuchElementException e) {
     ...
     public void confirmUploadReportViewPredefinedResponses() {
        try{
     ...
     public void confirmUploadReportViewNumeric() throws IOException, URISyntaxException {
        try {
            ...
            Assert.assertTrue(actualNumericReportViewText.contains(numericUploadExpected));
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm numeric entry");
        }
    }

     public void confirmUploadedReportViewEnterBoldText() throws IOException, URISyntaxException, InterruptedException {
        try {
            System.out.println("Confirming uploaded Enter Bold Text in report view");
            waitForWebElementToBeVisible(boldItemReportView);

            String reportViewEnterBoldText = boldItemReportView.getDomProperty("innerHTML");

            System.out.println("Enter Bold Text displayed in Report View: \n" + reportViewEnterBoldText);
            Assert.assertTrue(reportViewEnterBoldText.contains(uploadEnterBoldExpectedReportView), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }

     public void confirmUploadedReportViewEnterItalicsText() throws IOException, URISyntaxException, InterruptedException {
        try {
            System.out.println("Confirming uploaded Enter Bold Text in report view");
            waitForWebElementToBeVisible(italicsItemReportView);

            String reportViewEnterItalicsText = italicsItemReportView.getDomProperty("innerHTML");



            System.out.println("Enter Italics Text displayed in Report View: \n" + reportViewEnterItalicsText);
            Assert.assertTrue(reportViewEnterItalicsText.contains(uploadEnterItalicsExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }

     public void confirmUploadedReportViewEnterUnderlinedText() throws IOException, URISyntaxException, InterruptedException {
        try {
            System.out.println("Confirming uploaded Enter Underline Text in report view");
            waitForWebElementToBeVisible(underlinedItemReportView);

            String reportViewEnterUnderlinedText = underlinedItemReportView.getDomProperty("innerHTML");


            System.out.println("Enter Bold Text displayed in Report View: \n" + reportViewEnterUnderlinedText);
            Assert.assertTrue(reportViewEnterUnderlinedText.contains(uploadEnterUnderlinedExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }

     public void confirmUploadedReportViewEnterMultiFormattedText() throws IOException, URISyntaxException, InterruptedException {
        try {
            System.out.println("Confirming uploaded Enter MultiFormatted Text in report view");
            waitForWebElementToBeVisible(multiFormattedItemReportView);

            String reportViewEnterMultiFormattedText = multiFormattedItemReportView.getDomProperty("innerHTML");

            System.out.println("Enter Bold Text displayed in Report View: \n" + reportViewEnterMultiFormattedText);
            Assert.assertTrue(reportViewEnterMultiFormattedText.contains(uploadEnterMultiFormattedExpected), "Actual text does not contain expected text.");
        } catch (NoSuchElementException e) {
            Assert.fail("Unable to confirm preformatted text in report view");
        }
    }
    ...
    public void confirmUploadedCorrectMultiText(String multiItem) throws IOException, URISyntaxException {
        try {
            ...
            } else if (multiItem.equals("This is Baked in Tokens")) { // ensure exact key
    ...
    public void confirmUploadTextFormat(String format) throws IOException, URISyntaxException {
        try {
            ...
            if (format.equals("Enter Bold Text")) {
                formatExpected = uploadEnterBoldExpected;
            } else if (format.equals("Enter Italics Text")) {
                formatExpected = uploadEnterItalicsExpected;
            } else if (format.equals("Enter Underlined Text")) {
                formatExpected = uploadEnterUnderlinedExpected;
            } else if (format.equals("Enter Multi Formatted Text")) {
                formatExpected = uploadEnterMultiFormattedExpected;
            } else {
